...
- lock Crossby 0.37.2 for Codex Plan handoff (#521) (6dd4aa6)
- prepare Crossby 0.37.2 Plan handoff bump (#519) (304f5df)

### Other Changes

- Bump Wade to 1.2.9 (#520) (324d626)
...
- use sol high for planning (beec132)

## [v1.2.0] — 2026-09-08

### Features

- specialize review methodologies by lifecycle stage (#505) (75caed3)

## [v1.1.3] — 2026-09-08

### Chores

- configure wade workflow defaults (8062a91)
...
- review limitation on reviews (#500) (3479794)
...
- relaunch Codex with implementation network policy after plan handoff (#473) (202018b)

## [v0.53.0] — 2026-08-31

### Features

- decouple session workflows from dynamic skills (#470) (3f588a4)

## [v0.52.0] — 2026-08-23

### Features

- make sandboxed AI sessions ready and stage throwaway knowledge votes (#463) (e682f2c)

## [v0.51.0] — 2026-08-23

### Features

- Offer option to post comments to CodeRabbit and other after implementation and review sessions (#465) (caf9857)
...
- bump crossby to adopt the Antigravity CLI hook-contract fix (#456) (5cb582c)

## [v0.50.3] — 2026-08-19

### Bug Fixes

- pass changelog notes to gh release create via file, not inline template (1776e0d)
