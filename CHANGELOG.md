...
- centralize model resolution with correct fallback hierarchy (d9bb6c3)
...
- render allowlist prompt as plain text in wade init (03d6d0a)

## [v1.6.1] — 2026-03-03

### Bug Fixes

- add post-session wait for non-blocking tools in plan and deps services (683d76a)
...
- add tagline to README and update GitHub description (bf88957)

## [v1.5.5] — 2026-03-03

### Bug Fixes

- rewrite wade <N> as sys.argv transform instead of direct dispatch (85286a9)
...
- remove duplicate draft PR check and no-plan prompt from _smart_route_issue (917ac75)
...
- rewrite README for clarity and impact (384f4e2)
...
- halve banner width to 300px (a2143c7)

## [v1.4.2] — 2026-03-03

### Documentation

- reduce wade.png size (f8f9304)

## [v1.4.1] — 2026-03-03

### Documentation

- add wade.png banner to README (0304494)

## [v1.4.0] — 2026-03-03

### Features

- harden batch mode — beta label, stagger, dedup, retry, wezterm (322333a)
...
- deduplicate adapters, clean git layer, remove dead code, improve naming (f247a88)
