...
Reference for the `.md` format that `ghaiwpy task create --plan-file` expects.
...
`ghaiwpy work start` maps these to model names configured in `.ghaiw.yml`
