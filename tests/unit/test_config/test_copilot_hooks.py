"""Tests for Copilot hook configuration for plan and worktree sessions."""
...
from wade.config.copilot_hooks import configure_plan_hooks, configure_worktree_hooks


class TestCopilotWorktreeHooks:
